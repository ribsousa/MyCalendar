...
return [
    ...
    'evlist' => [// EvList Component
        'comp_name' => 'Componente Lista de Eventos',
        'description' => 'Exibe uma lista de eventos',
        'month_title' => 'Mês',
	'month_description' => 'O mês que deseja mostrar.',
	'year_title' => 'Ano',
	'year_description' => 'O ano qe deseja mostrar.',
	'events_title' => 'Eventos',
	'events_description' => 'Array de eventos que deseja mostrar.',
	'color_title' => 'Cor do ícone',
	'color_description' => 'A cor que você deseja para o ícone?.',
	'loadstyle_title' => 'Carregar folha de estilo',
        'loadstyle_description' => 'Carregar o arquivo CSS padrão.',
	'color_default' => 'vermelho',
	'opt_no' => 'Não',
        'opt_yes' => 'Sim',
        'color_red' => 'vermelho',
        'color_green' => 'verde',
    ...
    'event' => [// Event Component and Model
        ...
        'error_user_model' => 'Rainlab User Model Não está Instalado',
        'error_pick_month_year' => 'Escolha um Mês e um Ano',
